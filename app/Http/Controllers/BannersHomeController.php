...
class BannersHomeController extends Controller
{
    ...
    public function createImage(Request $request)
    {
        if ($file = $request->file('newPhoto')) {
            ...
            $path = 'bannershome/img/';
            $name = time() . '_.' . $file->getClientOriginalExtension();
            $file->storeAs($path, $name);
            
            $url = "http://ec2-3-145-159-204.us-east-2.compute.amazonaws.com:3010/api/create-bannerhome/";
            ...
            return redirect('bannersHome')->with('success', 'Imagen creada satisfactoriamente');
        }
    }
