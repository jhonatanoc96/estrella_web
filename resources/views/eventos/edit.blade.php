                ...
                <div class="card-body">
                    ...
                    <div class="pl-lg-4" id="formEdit">
                        <form id="formMainPhoto" method="POST" action="{{ url('/store-main-photo')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <label class="form-control-label" for="url_image">{{ __('Imágenes') }}</label>
                                </div>
                                <div class="col-md-12">
                        ...
                        <div class="text-center">
                            <form id="formMainPhoto" method="POST" action="{{ url('/update-event')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <input style="display: none;" type="hidden" name="url_image" value="{{$response['url_image']}}">
                                <input style="display: none;" type="hidden" name="_id_event" value="{{$response['_id']}}">
                                <button type="submit" id="guardarEditEvento" class="btn btn-success my-4">{{ __('GUARDAR') }}</button>
                            </form>
                        </div>
