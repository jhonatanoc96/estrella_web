...
<body class="{{ $class ?? '' }}">
    ...
    <div class="main-content">
                    ...
                    <div class="card shadow">
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                <h3 class="mb-0">{{ __('Crear concurso') }}</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            @csrf

                            <h6 class="heading-small text-muted mb-4">{{ __('Información del concurso') }}</h6>

                            <div class="pl-lg-4" id="formCreate">
                                <!-- <form id="frm" class="needs-validation" novalidate="" action="#" enctype="multipart/form-data"> -->
                                <form id="frmContest" method="POST" class="needs-validation" novalidate="" action="{{ url('/store-files-contest')}}" enctype="multipart/form-data">
                                    <label class="form-control-label" for="nameCreateContest">{{ __('Nombre') }}</label>
                                    <input type="text" name="name" id="nameCreateContest" class="form-control" placeholder="{{ __('Nombre') }}" required autofocus>
                                    <br>
                                    <label class="form-control-label" for="descriptionCreateContest">{{ __('Descripción') }}</label>
                                    <input type="text" name="description" id="descriptionCreateContest" class="form-control" placeholder="{{ __('Descripción') }}" required autofocus>
                                    <br>
                                    ...
                                    <div class="form-group row">
                                        <div class="input-group">
                                            ...
                                            <input type="file" id="filesContest" name="filesContest[]" data-button="" multiple accept="image/jpeg, image/png, image/gif,">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4 offset-md-8 text-center mb-4">
                                        <button id="btnSubmitContest" class="btn btn-block btn-outline-success float-right" data-toggle="tooltip" data-trigger="manual" data-placement="top" data-title="Continue">
                                            Crear concurso<span id="btnContinueIcon" class="fa fa-chevron-circle-right ml-2"></span><span id="btnContinueLoading" class="fa fa-spin fa-spinner ml-2" style="display:none"></span>
                                        </button>
        ...
        <script type="text/javascript" src="{{ asset('assets/js/contest/create.js') }}"></script>
