...
<body class="{{ $class ?? '' }}">
    ...
    <div class="main-content">
                ...
                <div class="col-xl-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Información de la emisora') }}</h6>

                            <div class="pl-lg-4" id="formCreate">
                                <!-- <form id="frm" class="needs-validation" novalidate="" action="#" enctype="multipart/form-data"> -->
                                <form id="frmEmisora" method="POST" class="needs-validation" novalidate="" action="{{ url('/store-file-radio')}}" enctype="multipart/form-data">
                                    ...
                                    <br>
                                    <label class="form-control-label" for="urlCreate">{{ __('URL') }}</label>
                                    <input type="text" name="url" id="urlCreate" class="form-control" placeholder="{{ __('URL') }}" required autofocus>
                                    <br>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4 offset-md-8 text-center mb-4">
                                        <button id="btnSubmitEmisora" class="btn btn-block btn-outline-success float-right" data-toggle="tooltip" data-trigger="manual" data-placement="top" data-title="Continue">
                                            Crear emisora<span id="btnContinueIcon" class="fa fa-chevron-circle-right ml-2"></span><span id="btnContinueLoading" class="fa fa-spin fa-spinner ml-2" style="display:none"></span>
                                        </button>
        ...
        <script type="text/javascript" src="{{ asset('assets/js/radio/create.js') }}"></script>
